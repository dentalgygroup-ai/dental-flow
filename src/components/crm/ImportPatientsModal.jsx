...
const TEMPLATE_HEADERS = [
  ...
  'budget_amount', 'sold_amount', 'budget_currency',
...
const TEMPLATE_LABELS = {
  ...
  budget_amount: 'Presupuesto entregado (número)',
  sold_amount: 'Importe vendido (número)',
...
function rowToPatient(row, clinicId) {
  ...
  return {
    ...
    sold_amount: row.sold_amount ? parseFloat(row.sold_amount) : undefined,
